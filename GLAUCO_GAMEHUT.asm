...
MAIN:
		...
		;ADD.W	#1,PLAY1X			;AUTO SCROLL PLAYFIELD 1 (ADD RIGHT / SUB LEFT) BY ONE PIXEL
		;ADD.W	#1,PLAY1Y			;AUTO SCROLL PLAYFIELD 1 (ADD UP / SUB DOWN) BY ONE PIXEL
		;SUB.W	#1,PLAY2X			;AUTO SCROLL PLAYFIELD 1 (ADD RIGHT / SUB LEFT) BY ONE PIXEL
		;SUB.W	#1,PLAY2Y			;AUTO SCROLL PLAYFIELD 1 (ADD UP / SUB DOWN) BY ONE PIXEL
